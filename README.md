...
### NOTATION
- If you wish to create a custom AT command for your router, you would use something like this `AT+CGDCONT=1,"IP","**APN**";ATD**NumberDialed**`, supposedly you can add to that somehow with some of the commands you found in your command list.
